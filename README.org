...
- [[file:proto/deck-config.org][deck_config.config]] - Scheduling algorithm parameters
...
- Code/field names: =monospace=
- Emphasis: *bold*
- Cross-references: [[link][description]]
- SQL/code blocks: =#+begin_src= blocks
- Tables: Org-mode table syntax
